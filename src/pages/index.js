          ...
          <div class="row">
            <div class="col-lg-6">
              <div style="margin-top: 230px;">
                <h1>Crunchy Bread</h1>
                <p>
                  Are you hungry and out of time? Crunchy Bread's got you
                  covered! Order any luscious crunchy delicacy from the comfort
                  of your home and have it delivered to you in no time.
                </p>
                <Link to="/products">
                  <button className="bg-transparent hover:bg-purple-900 text-gray-900 hover:text-white rounded shadow hover:shadow-lg py-auto px-4 border border-gray-900 hover:border-transparent">
                    Let's Get Crunchy!
